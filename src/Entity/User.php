...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Incredient::class, orphanRemoval: true)]
    ...
    /**
     * @return Collection<int, Incredient>
     */
    ...
    public function addIngredient(Incredient $ingredient): self
    {
    ...
    public function removeIngredient(Incredient $ingredient): self
    {
